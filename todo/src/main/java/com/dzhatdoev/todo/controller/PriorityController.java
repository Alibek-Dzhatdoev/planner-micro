...
public class PriorityController {
    ...
    public ResponseEntity<List<Priority>> search(@RequestBody PrioritySearchValues prioritySearchValues) {
        ...
        // проверка на обязательные параметры
        if (prioritySearchValues.getTitle() == null || prioritySearchValues.getTitle().trim().length() == 0) {
            return new ResponseEntity("missed param: " + prioritySearchValues.getTitle(), HttpStatus.NOT_ACCEPTABLE);
        }
